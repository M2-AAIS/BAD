...
module mod_constants
  ...
  integer, parameter, public :: output_freq  = 5000                   ! Frequency of the outputs
  real(kind = x_precision), parameter, public :: cst_dt_nu = 100._x_precision
  real(kind = x_precision), parameter, public :: cst_dt_T = 10._x_precision
  ! Specific to s_curve
  ...
  type state
    real(kind = x_precision), dimension(n_cell) :: nu, v, cs, S, H, Mdot, rho, T, Fz, Cv, Pgaz, Prad, beta, Qplus, Qminus, tau
    ! nu     : Viscosity
